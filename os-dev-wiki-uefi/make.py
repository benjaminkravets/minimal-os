...
#os.system("clang -target x86_64-unknown-windows -ffreestanding -fshort-wchar -mno-red-zone -I../../gnu-efi/inc/ -I../../gnu-efi/inc/x86_64/ -I../../gnu-efi/inc/protocol/ -c -o hello.o hello.c")
