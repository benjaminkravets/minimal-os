...
static segment_descriptor segments[8192];
...
uint16_t add_segment(descriptor_table* t, uint32_t base, uint32_t limit, uint32_t access, uint16_t id, uint8_t auto_id) {
    ...
    } while (t->free_id < 8192);

    s->first = (((((~(~0 << (15 - 0 + 1))) << 0) & base) >> 0) << 16) | ((((~(~0 << (15 - 0 + 1))) << 0) & limit) >> 0);
    s->second = (((((~(~0 << (31 - 24 + 1))) << 24) & base) >> 24) << 24) | access | ((((~(~0 << (23 - 16 + 1))) << 16) & base) >> 16);
...
void setup_gdt(struct tss* init_tss) {
  add_segment(&gdt, 0x0, 0x0, 0x0, 0x0, 1);

  add_segment(&gdt, 0x0000, 0xFFFF, (1 << 23) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1)

                                                                   ;

  add_segment(&gdt, 0x0000, 0xFFFF, (1 << 23) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1)

                                                                    ;

  add_segment(&gdt, (uintptr_t) init_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1)

                                                                             ;

  add_segment(&gdt, 0xB8000, 0x7FFF, (1 << 23) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x2 << 8), 0x0, 1)

                                                                   ;

  add_segment(&gdt, (uintptr_t) &segments, 8192, (1 << 23) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x2 << 8), 0x0, 1)
