...
void setup_irq() {
    irq0_init(); add_segment(&idt, (task_id_irq0 << 3), 0x0000, (0x85 << 8), 0, 0);
    irq1_init(); add_segment(&idt, (task_id_irq1 << 3), 0x0000, (0x85 << 8), 1, 0);
    irq8_init(); add_segment(&idt, (task_id_irq8 << 3), 0x0000, (0x85 << 8), 8, 0);
    irq10_init(); add_segment(&idt, (task_id_irq10 << 3), 0x0000, (0x85 << 8), 10, 0);
    irq11_init(); add_segment(&idt, (task_id_irq11 << 3), 0x0000, (0x85 << 8), 11, 0);
    irq13_init(); add_segment(&idt, (task_id_irq13 << 3), 0x0000, (0x85 << 8), 13, 0);
    irq32_init(); add_segment(&idt, (task_id_irq32 << 3), 0x0000, (0x85 << 8), 32, 0);
...
void __TASK_END_irq0(); void __TASK_START_irq0(){} segment_descriptor irq0_ldt_segments[3]; ldt_t ldt_irq0; uint16_t task_id_irq0; struct tss irq0_tss = { .link_r = 0x3 << 3, .ss0_r = ((0x2 << 3)), .eip = (uintptr_t) divide_by_zero_handler, .esp = 0x3000, .eflags = 0x87, .cr3 = 0x2000, .es_r = ((0x4 << 3)), .cs_r = (0x1 << 3), .ds_r = ((0x2 << 3)), .ss_r = ((0x2 << 3)), .fs_r = ((0x2 << 3)), .gs_r = ((0x2 << 3)), }; void irq0_init() { uint16_t ldt_id; ldt_irq0.base = irq0_ldt_segments; ldt_irq0.size = 8 * 3; ldt_irq0.free_id = 0; task_id_irq0 = add_segment(&gdt, (uintptr_t) &irq0_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1); ldt_id = add_segment(&gdt, (uintptr_t) &irq0_ldt_segments, ldt_irq0.size, 0 | (1 << 22) | 0 | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x2 << 8), 0x0, 1); irq0_tss.esp0 = 0x35000 + task_id_irq0 * 0x1000; irq0_tss.esp = 0x35000 + task_id_irq0 * 0x1000; irq0_tss.ldt_r = ldt_id << 3; add_segment(&ldt_irq0, 0, 0, 0, 0x0, 1); add_segment(&ldt_irq0, (uintptr_t) __TASK_START_irq0, __TASK_END_irq0 - __TASK_START_irq0, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1); add_segment(&ldt_irq0, 0x35000 + task_id_irq0 * 0x1000, 0xFFFF, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1); } void irq0_start() { asm("pushw 0xa0"); asm("pushd 0x0"); asm("jmp FAR PTR  [esp]"); };
void divide_by_zero_handler() {
    asm("add esp, 0x4"); asm("leave"); asm("pop eax"); asm("iret");

    divide_by_zero_handler();
}
void __TASK_END_irq0() {};

void __TASK_END_irq1(); void __TASK_START_irq1(){} segment_descriptor irq1_ldt_segments[3]; ldt_t ldt_irq1; uint16_t task_id_irq1; struct tss irq1_tss = { .link_r = 0x3 << 3, .ss0_r = ((0x2 << 3)), .eip = (uintptr_t) debug_exception, .esp = 0x3000, .eflags = 0x87, .cr3 = 0x2000, .es_r = ((0x4 << 3)), .cs_r = (0x1 << 3), .ds_r = ((0x2 << 3)), .ss_r = ((0x2 << 3)), .fs_r = ((0x2 << 3)), .gs_r = ((0x2 << 3)), }; void irq1_init() { uint16_t ldt_id; ldt_irq1.base = irq1_ldt_segments; ldt_irq1.size = 8 * 3; ldt_irq1.free_id = 0; task_id_irq1 = add_segment(&gdt, (uintptr_t) &irq1_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1); ldt_id = add_segment(&gdt, (uintptr_t) &irq1_ldt_segments, ldt_irq1.size, 0 | (1 << 22) | 0 | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x2 << 8), 0x0, 1); irq1_tss.esp0 = 0x35000 + task_id_irq1 * 0x1000; irq1_tss.esp = 0x35000 + task_id_irq1 * 0x1000; irq1_tss.ldt_r = ldt_id << 3; add_segment(&ldt_irq1, 0, 0, 0, 0x0, 1); add_segment(&ldt_irq1, (uintptr_t) __TASK_START_irq1, __TASK_END_irq1 - __TASK_START_irq1, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1); add_segment(&ldt_irq1, 0x35000 + task_id_irq1 * 0x1000, 0xFFFF, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1); } void irq1_start() { asm("pushw 0xa0"); asm("pushd 0x0"); asm("jmp FAR PTR  [esp]"); };
void debug_exception() {
    asm("int 8");

}
void __TASK_END_irq1() {};

void __TASK_END_irq8(); void __TASK_START_irq8(){} segment_descriptor irq8_ldt_segments[3]; ldt_t ldt_irq8; uint16_t task_id_irq8; struct tss irq8_tss = { .link_r = 0x3 << 3, .ss0_r = ((0x2 << 3)), .eip = (uintptr_t) double_fault_handler, .esp = 0x3000, .eflags = 0x87, .cr3 = 0x2000, .es_r = ((0x4 << 3)), .cs_r = (0x1 << 3), .ds_r = ((0x2 << 3)), .ss_r = ((0x2 << 3)), .fs_r = ((0x2 << 3)), .gs_r = ((0x2 << 3)), }; void irq8_init() { uint16_t ldt_id; ldt_irq8.base = irq8_ldt_segments; ldt_irq8.size = 8 * 3; ldt_irq8.free_id = 0; task_id_irq8 = add_segment(&gdt, (uintptr_t) &irq8_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1); ldt_id = add_segment(&gdt, (uintptr_t) &irq8_ldt_segments, ldt_irq8.size, 0 | (1 << 22) | 0 | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x2 << 8), 0x0, 1); irq8_tss.esp0 = 0x35000 + task_id_irq8 * 0x1000; irq8_tss.esp = 0x35000 + task_id_irq8 * 0x1000; irq8_tss.ldt_r = ldt_id << 3; add_segment(&ldt_irq8, 0, 0, 0, 0x0, 1); add_segment(&ldt_irq8, (uintptr_t) __TASK_START_irq8, __TASK_END_irq8 - __TASK_START_irq8, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1); add_segment(&ldt_irq8, 0x35000 + task_id_irq8 * 0x1000, 0xFFFF, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1); } void irq8_start() { asm("pushw 0xa0"); asm("pushd 0x0"); asm("jmp FAR PTR  [esp]"); };
void double_fault_handler(uint32_t error_code) {
    int i = error_code;
    asm("add esp, 0x4"); asm("leave"); asm("pop eax"); asm("iret");
    __builtin_unreachable ();
}
void __TASK_END_irq8() {};

void __TASK_END_irq10(); void __TASK_START_irq10(){} segment_descriptor irq10_ldt_segments[3]; ldt_t ldt_irq10; uint16_t task_id_irq10; struct tss irq10_tss = { .link_r = 0x3 << 3, .ss0_r = ((0x2 << 3)), .eip = (uintptr_t) invalid_tss_handler, .esp = 0x3000, .eflags = 0x87, .cr3 = 0x2000, .es_r = ((0x4 << 3)), .cs_r = (0x1 << 3), .ds_r = ((0x2 << 3)), .ss_r = ((0x2 << 3)), .fs_r = ((0x2 << 3)), .gs_r = ((0x2 << 3)), }; void irq10_init() { uint16_t ldt_id; ldt_irq10.base = irq10_ldt_segments; ldt_irq10.size = 8 * 3; ldt_irq10.free_id = 0; task_id_irq10 = add_segment(&gdt, (uintptr_t) &irq10_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1); ldt_id = add_segment(&gdt, (uintptr_t) &irq10_ldt_segments, ldt_irq10.size, 0 | (1 << 22) | 0 | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x2 << 8), 0x0, 1); irq10_tss.esp0 = 0x35000 + task_id_irq10 * 0x1000; irq10_tss.esp = 0x35000 + task_id_irq10 * 0x1000; irq10_tss.ldt_r = ldt_id << 3; add_segment(&ldt_irq10, 0, 0, 0, 0x0, 1); add_segment(&ldt_irq10, (uintptr_t) __TASK_START_irq10, __TASK_END_irq10 - __TASK_START_irq10, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1); add_segment(&ldt_irq10, 0x35000 + task_id_irq10 * 0x1000, 0xFFFF, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1); } void irq10_start() { asm("pushw 0xa0"); asm("pushd 0x0"); asm("jmp FAR PTR  [esp]"); };
void invalid_tss_handler() {
    asm("mov eax, [ebp + 4]");
    int error_code = 0;
...
void __TASK_END_irq10() {};

void __TASK_END_irq11(); void __TASK_START_irq11(){} segment_descriptor irq11_ldt_segments[3]; ldt_t ldt_irq11; uint16_t task_id_irq11; struct tss irq11_tss = { .link_r = 0x3 << 3, .ss0_r = ((0x2 << 3)), .eip = (uintptr_t) segment_not_present, .esp = 0x3000, .eflags = 0x87, .cr3 = 0x2000, .es_r = ((0x4 << 3)), .cs_r = (0x1 << 3), .ds_r = ((0x2 << 3)), .ss_r = ((0x2 << 3)), .fs_r = ((0x2 << 3)), .gs_r = ((0x2 << 3)), }; void irq11_init() { uint16_t ldt_id; ldt_irq11.base = irq11_ldt_segments; ldt_irq11.size = 8 * 3; ldt_irq11.free_id = 0; task_id_irq11 = add_segment(&gdt, (uintptr_t) &irq11_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1); ldt_id = add_segment(&gdt, (uintptr_t) &irq11_ldt_segments, ldt_irq11.size, 0 | (1 << 22) | 0 | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x2 << 8), 0x0, 1); irq11_tss.esp0 = 0x35000 + task_id_irq11 * 0x1000; irq11_tss.esp = 0x35000 + task_id_irq11 * 0x1000; irq11_tss.ldt_r = ldt_id << 3; add_segment(&ldt_irq11, 0, 0, 0, 0x0, 1); add_segment(&ldt_irq11, (uintptr_t) __TASK_START_irq11, __TASK_END_irq11 - __TASK_START_irq11, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1); add_segment(&ldt_irq11, 0x35000 + task_id_irq11 * 0x1000, 0xFFFF, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1); } void irq11_start() { asm("pushw 0xa0"); asm("pushd 0x0"); asm("jmp FAR PTR  [esp]"); };
void segment_not_present(uint32_t error_code) {
    asm("add esp, 0x4"); asm("leave"); asm("pop eax"); asm("iret");
}
void __TASK_END_irq11() {};

void __TASK_END_irq13(); void __TASK_START_irq13(){} segment_descriptor irq13_ldt_segments[3]; ldt_t ldt_irq13; uint16_t task_id_irq13; struct tss irq13_tss = { .link_r = 0x3 << 3, .ss0_r = ((0x2 << 3)), .eip = (uintptr_t) general_protection_exception, .esp = 0x3000, .eflags = 0x87, .cr3 = 0x2000, .es_r = ((0x4 << 3)), .cs_r = (0x1 << 3), .ds_r = ((0x2 << 3)), .ss_r = ((0x2 << 3)), .fs_r = ((0x2 << 3)), .gs_r = ((0x2 << 3)), }; void irq13_init() { uint16_t ldt_id; ldt_irq13.base = irq13_ldt_segments; ldt_irq13.size = 8 * 3; ldt_irq13.free_id = 0; task_id_irq13 = add_segment(&gdt, (uintptr_t) &irq13_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1); ldt_id = add_segment(&gdt, (uintptr_t) &irq13_ldt_segments, ldt_irq13.size, 0 | (1 << 22) | 0 | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x2 << 8), 0x0, 1); irq13_tss.esp0 = 0x35000 + task_id_irq13 * 0x1000; irq13_tss.esp = 0x35000 + task_id_irq13 * 0x1000; irq13_tss.ldt_r = ldt_id << 3; add_segment(&ldt_irq13, 0, 0, 0, 0x0, 1); add_segment(&ldt_irq13, (uintptr_t) __TASK_START_irq13, __TASK_END_irq13 - __TASK_START_irq13, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1); add_segment(&ldt_irq13, 0x35000 + task_id_irq13 * 0x1000, 0xFFFF, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1); } void irq13_start() { asm("pushw 0xa0"); asm("pushd 0x0"); asm("jmp FAR PTR  [esp]"); };
void general_protection_exception() {
_start:
    asm("mov eax, [ebp + 4]");
    int error_code = 0;
...
void __TASK_END_irq13() {};

void __TASK_END_irq32(); void __TASK_START_irq32(){} segment_descriptor irq32_ldt_segments[3]; ldt_t ldt_irq32; uint16_t task_id_irq32; struct tss irq32_tss = { .link_r = 0x3 << 3, .ss0_r = ((0x2 << 3)), .eip = (uintptr_t) lapic_timer_handler, .esp = 0x3000, .eflags = 0x87, .cr3 = 0x2000, .es_r = ((0x4 << 3)), .cs_r = (0x1 << 3), .ds_r = ((0x2 << 3)), .ss_r = ((0x2 << 3)), .fs_r = ((0x2 << 3)), .gs_r = ((0x2 << 3)), }; void irq32_init() { uint16_t ldt_id; ldt_irq32.base = irq32_ldt_segments; ldt_irq32.size = 8 * 3; ldt_irq32.free_id = 0; task_id_irq32 = add_segment(&gdt, (uintptr_t) &irq32_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1); ldt_id = add_segment(&gdt, (uintptr_t) &irq32_ldt_segments, ldt_irq32.size, 0 | (1 << 22) | 0 | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x2 << 8), 0x0, 1); irq32_tss.esp0 = 0x35000 + task_id_irq32 * 0x1000; irq32_tss.esp = 0x35000 + task_id_irq32 * 0x1000; irq32_tss.ldt_r = ldt_id << 3; add_segment(&ldt_irq32, 0, 0, 0, 0x0, 1); add_segment(&ldt_irq32, (uintptr_t) __TASK_START_irq32, __TASK_END_irq32 - __TASK_START_irq32, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1); add_segment(&ldt_irq32, 0x35000 + task_id_irq32 * 0x1000, 0xFFFF, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1); } void irq32_start() { asm("pushw 0xa0"); asm("pushd 0x0"); asm("jmp FAR PTR  [esp]"); };
...
_start:
    ...
    ; uint32_t* eoi = (uint32_t *)((uintptr_t) 0xfee00000 + 0x00b0);; *eoi = 1;;
    asm("add esp, 0x4"); asm("leave"); asm("pop eax"); asm("iret");
    asm("mov ebp, esp");
    asm("sub ebp, 4");
    goto _start;
}
void __TASK_END_irq32() {};

void __TASK_END_irq20(); void __TASK_START_irq20(){} segment_descriptor irq20_ldt_segments[3]; ldt_t ldt_irq20; uint16_t task_id_irq20; struct tss irq20_tss = { .link_r = 0x3 << 3, .ss0_r = ((0x2 << 3)), .eip = (uintptr_t) double_fault_handler2, .esp = 0x3000, .eflags = 0x87, .cr3 = 0x2000, .es_r = ((0x4 << 3)), .cs_r = (0x1 << 3), .ds_r = ((0x2 << 3)), .ss_r = ((0x2 << 3)), .fs_r = ((0x2 << 3)), .gs_r = ((0x2 << 3)), }; void irq20_init() { uint16_t ldt_id; ldt_irq20.base = irq20_ldt_segments; ldt_irq20.size = 8 * 3; ldt_irq20.free_id = 0; task_id_irq20 = add_segment(&gdt, (uintptr_t) &irq20_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1); ldt_id = add_segment(&gdt, (uintptr_t) &irq20_ldt_segments, ldt_irq20.size, 0 | (1 << 22) | 0 | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x2 << 8), 0x0, 1); irq20_tss.esp0 = 0x35000 + task_id_irq20 * 0x1000; irq20_tss.esp = 0x35000 + task_id_irq20 * 0x1000; irq20_tss.ldt_r = ldt_id << 3; add_segment(&ldt_irq20, 0, 0, 0, 0x0, 1); add_segment(&ldt_irq20, (uintptr_t) __TASK_START_irq20, __TASK_END_irq20 - __TASK_START_irq20, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1); add_segment(&ldt_irq20, 0x35000 + task_id_irq20 * 0x1000, 0xFFFF, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1); } void irq20_start() { asm("pushw 0xa0"); asm("pushd 0x0"); asm("jmp FAR PTR  [esp]"); };
void double_fault_handler2(uint32_t error_code) {
    asm("add esp, 0x4"); asm("leave"); asm("pop eax"); asm("iret");
}
void __TASK_END_irq20() {};
