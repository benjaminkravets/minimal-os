...
void lapic_enable_timer(uint8_t mode, uint32_t init_count, uint32_t div_config, uint32_t vec_num) {
    uint32_t* timer_reg = (uint32_t *)((uintptr_t) 0xfee00000 + 0x0320);;
    uint32_t* lapic_base = (uint32_t *)((uintptr_t) 0x1b);;
...
uint32_t lapic_get_version() {
    uint32_t* ver = (uint32_t *)((uintptr_t) 0xfee00000 + 0x0030);;
    return *ver;
}
...
uint32_t lapic_get_current_timer_count() {
    uint32_t* count = (uint32_t *)((uintptr_t) 0xfee00000 + 0x0390);;
    return *count;
}

uint32_t lapic_get_error_status() {
    uint32_t* status = (uint32_t *)((uintptr_t) 0xfee00000 + 0x0280);;
    return *status;
}

void lapic_set_timer_initial_count(uint32_t count) {
    uint32_t* timer_init_count_reg = (uint32_t *)((uintptr_t) 0xfee00000 + 0x0380);;
    *timer_init_count_reg = count;
}

void lapic_set_divide_config(uint32_t d) {
    uint32_t* div_reg = (uint32_t *)((uintptr_t) 0xfee00000 + 0x03E0);;
    *div_reg = d;
}
