...
void __TASK_END_task1(); void __TASK_START_task1(){} segment_descriptor task1_ldt_segments[3]; ldt_t ldt_task1; uint16_t task_id_task1; struct tss task1_tss = { .link_r = 0x3 << 3, .ss0_r = ((0x2 << 3)), .eip = (uintptr_t) init_task1, .esp = 0x3000, .eflags = 0x87, .cr3 = 0x2000, .es_r = ((0x4 << 3)), .cs_r = (0x1 << 3), .ds_r = ((0x2 << 3)), .ss_r = ((0x2 << 3)), .fs_r = ((0x2 << 3)), .gs_r = ((0x2 << 3)), }; void task1_init() { uint16_t ldt_id; ldt_task1.base = task1_ldt_segments; ldt_task1.size = 8 * 3; ldt_task1.free_id = 0; task_id_task1 = add_segment(&gdt, (uintptr_t) &task1_tss, 0x067, 0 | (1 << 20) | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x9 << 8), 0x0, 1); ldt_id = add_segment(&gdt, (uintptr_t) &task1_ldt_segments, ldt_task1.size, 0 | (1 << 22) | 0 | (0x0 << 16) | (1 << 15) | (0x0 << 13) | 0 | (0x2 << 8), 0x0, 1); task1_tss.esp0 = 0x35000 + task_id_task1 * 0x1000; task1_tss.esp = 0x35000 + task_id_task1 * 0x1000; task1_tss.ldt_r = ldt_id << 3; add_segment(&ldt_task1, 0, 0, 0, 0x0, 1); add_segment(&ldt_task1, (uintptr_t) __TASK_START_task1, __TASK_END_task1 - __TASK_START_task1, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0xA << 8), 0x0, 1); add_segment(&ldt_task1, 0x35000 + task_id_task1 * 0x1000, 0xFFFF, (1 << 23) | (1 << 20) | (1 << 22) | 0 | (0xf << 16) | (1 << 15) | (0x0 << 13) | (0x1 << 12) | (0x6 << 8), 0x0, 1); } void task1_start() { asm("pushw 0xa0"); asm("pushd 0x0"); asm("jmp FAR PTR  [esp]"); };
int task1_var;
